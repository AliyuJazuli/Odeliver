    ...
    Surface(
        ...
        Column(
            modifier = Modifier
                .padding(top = 200.dp)
                .fillMaxSize()
                .background(MaterialTheme.colorScheme.background, shape = RoundedCornerShape(topStart = 40.dp))
        ) {
            ...
            Column(
                ...
                Text("Welcome to odeliver", fontSize = 28.sp, modifier = Modifier.padding(20.dp))
